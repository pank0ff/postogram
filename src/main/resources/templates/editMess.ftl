    ...
    <#if lang>
        <form method="post" action="/user/profile/update/${message.id}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                <input type ="text" name="tag" placeholder="topic" class="form-control" value="${message.getTag()!''}"/>
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-2 col-form-label">Hashtag:</label>
            <div class="col-sm-6">
                <input  type="text" name="hashtag" class="form-control" placeholder="hashtag(#..)" value="${message.hashtag!''}" />
            </div>
        </div>
        <div class="form-group row">
    ...
    <#else>
        <form method="post" action="/user/profile/update/${message.id}" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input type ="text" name="tag" class="form-control" placeholder="тема" value="${message.getTag()!''}"/>
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Хэш-тэг:</label>
                <div class="col-sm-6">
                    <input  type="text" name="hashtag" class="form-control" placeholder="хэш-тэг(#..)"
